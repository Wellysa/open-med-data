# http://onkologia.org.pl/pl/nowotwor-pecherza-moczowego-stadia-zaawansowania

(Snapshot from KRN portal, downloaded by crawl_krn_portal.py)

# Nowotwór pęcherza moczowegoStadia zaawansowania
![](https://onkologia.org.pl/sites/default/files/media/2021-10/AdobeStock_49608511%20%281%29.jpg)
## Stadia zaawansowania
Powszechnie obowiązującym systemem do oceny stopnia zaawansowania nowotworów jest system TNM – oceniający guz (
T – tumor
), zajęcie wezłów chłonnych w pobliżu guza lub odległych (
N – node
) oraz obecność lub brak przerzutów odległych (
M – metastases
). Na podstawie tych cech ocenia się stopień zaawansowania nowotworu – najczęściej w skali od I do IV.
