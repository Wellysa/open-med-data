# http://onkologia.org.pl/pl/zespol-poems-czym-jest

(Snapshot from KRN portal, downloaded by crawl_krn_portal.py)

# Zespół POEMSCzym jest?
![](https://onkologia.org.pl/sites/default/files/media/2021-10/AdobeStock_293937794.jpeg)
## Czym jest zespół POEMS?
Zespół POEMS to choroba komórek plazmatycznych określana akronimem opartym na skojarzeniu występujących objawów, czyli
p
olineuropatii (uszkodzenia nerwów), powiększenia narządów wewnętrznych (
o
rganomegalia), zaburzeń
e
ndokrynnych (wydzielania hormonów), białka
m
onoklonalnego (nieprawidłowego białka) i zmian
s
kórnych (POEMS).
