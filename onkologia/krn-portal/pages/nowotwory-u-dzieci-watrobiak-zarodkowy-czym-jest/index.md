# http://onkologia.org.pl/pl/nowotwory-u-dzieci-watrobiak-zarodkowy-czym-jest

(Snapshot from KRN portal, downloaded by crawl_krn_portal.py)

# Nowotwory u dzieci - wątrobiak zarodkowyCzym jest?
![](https://onkologia.org.pl/sites/default/files/media/2021-10/AdobeStock_230609079.jpeg)
## Czym jest wątrobiak zarodkowy (Hepatoblastoma)?
Rocznie jest rozpoznawanych w Polsce  około 15 nowych zachorowań u dzieci na pierwotne nowotwory wątroby. Najczęstszym nowotworem jest wątrobiak zarodkowy (
hepatoblastoma
). Stanowi on ok. 75% nowotworów wątroby i występuje głównie u małych dzieci poniżej 2. roku życia.
