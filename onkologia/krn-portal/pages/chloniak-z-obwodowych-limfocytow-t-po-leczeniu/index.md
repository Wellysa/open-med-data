# http://onkologia.org.pl/pl/chloniak-z-obwodowych-limfocytow-t-po-leczeniu

(Snapshot from KRN portal, downloaded by crawl_krn_portal.py)

# Chłoniak z obwodowych limfocytów TPo leczeniu
...
Pomocą w tej dziedzinie może być udział w grupie wsparcia lub stowarzyszeniu, jak np. Stowarzyszenie Sowie Oczy (
[http://www.sowieoczy.pl/](http://www.sowieoczy.pl/)
) lub Stowarzyszenie Przyjaciół Chorych na Chłoniaki „Przebiśnieg” (
[http://www.przebisnieg.org](http://www.przebisnieg.org/)
).
