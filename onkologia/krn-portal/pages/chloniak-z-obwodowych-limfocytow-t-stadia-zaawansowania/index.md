# http://onkologia.org.pl/pl/chloniak-z-obwodowych-limfocytow-t-stadia-zaawansowania

(Snapshot from KRN portal, downloaded by crawl_krn_portal.py)

# Chłoniak z obwodowych limfocytów TStadia zaawansowania
![](https://onkologia.org.pl/sites/default/files/media/2021-09/AdobeStock_281980480_1.jpeg)
## Stadia zaawansowania
Stadium zaawansowania choroby określa się według
[klasyfikacji Ann Arbor](https://onkologia.org.pl/sites/default/files/Stopnie-zaawansowania-ch%C5%82oniak%C3%B3w.pdf)
na podstawie liczby i umiejscowienia zajętych okolic węzłowych oraz obecności objawów systemowych.
